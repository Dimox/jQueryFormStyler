/* jQuery Form Styler v1.2.2 | (c) Dimox | http://dimox.name/jquery-form-styler/ */
...
q!=b&&(c(this).addClass("selected sel").siblings().removeClass("selected sel"),e.eq(c(this).index()).attr("selected",!0).siblings().removeAttr("selected"),q=b,g.text(b),a.change());d.hide()});d.mouseout(function(){d.find("li.sel").addClass("selected")});a.focus(function(){c("span.selectbox").removeClass("focused");f.addClass("focused")}).keyup(function(){g.text(e.filter(":selected").text());l.removeClass("selected sel").eq(e.filter(":selected").index()).addClass("selected sel")});c(document).on("click",
function(a){c(a.target).parents().hasClass("selectbox")||(d.hide().find("li.sel").addClass("selected"),f.removeClass("focused"))})}},q=function(){var f=c("<span"+n+' class="selectMultiple jqselect'+cl+'" style="display:inline-block"></span>');a.after(f).css({position:"absolute",left:-9999});var j=a.find("option"),g="";for(i=0;i<j.length;i++){var e="";"undefined"!==typeof j.eq(i).attr("selected")&&!1!==j.eq(i).attr("selected")&&(e=' class="selected"');j.eq(i).is(":disabled")&&(e=' class="disabled"');
j.eq(i).is(":selected:disabled")&&(e=' class="selected disabled"');g+="<li"+e+">"+j.eq(i).text()+"</li>"}f.append("<ul>"+g+"</ul>");var g=f.find("ul"),h=f.find("li").attr("unselectable","on").css({"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","-o-user-select":"none","user-select":"none"}),e=a.attr("size"),k=g.outerHeight(),d=h.outerHeight();void 0!==e&&0<e?g.css({height:d*e}):g.css({height:4*d});k>f.height()&&(g.css("overflowY","scroll"),b(g));a.is(":disabled")?(f.addClass("disabled"),
j.each(function(){c(this).is(":selected")&&h.eq(c(this).index()).addClass("selected")})):h.filter(":not(.disabled)").click(function(b){var d=c(this);b.ctrlKey||d.addClass("selected");b.shiftKey||d.addClass("first");!b.ctrlKey&&!b.shiftKey&&d.siblings().removeClass("selected first");b.ctrlKey&&(d.is(".selected")?d.removeClass("selected first"):d.addClass("selected first"),d.siblings().removeClass("first"));if(b.shiftKey){var e=next=!1;d.siblings().removeClass("selected").siblings(".first").addClass("selected");
d.prevAll().each(function(){c(this).is(".first")&&(e=!0)});d.nextAll().each(function(){c(this).is(".first")&&(next=!0)});e&&d.prevAll().each(function(){if(c(this).is(".selected"))return!1;c(this).not(".disabled").addClass("selected")});next&&d.nextAll().each(function(){if(c(this).is(".selected"))return!1;c(this).not(".disabled").addClass("selected")});1==h.filter(".selected").length&&d.addClass("first")}j.removeAttr("selected");h.filter(".selected").each(function(){j.eq(c(this).index()).attr("selected",
!0)});a.change()})};a.is("[multiple]")?q():k();a.on("refresh",function(){a.next().remove();a.is("[multiple]")?q():k()})}})})}})(jQuery);