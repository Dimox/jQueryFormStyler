/* jQuery Form Styler v1.5.3 | (c) Dimox | https://github.com/Dimox/jQueryFormStyler */
...
if(a.is(":disabled"))return d.addClass("disabled"),!1;s.click(function(){a.trigger("focus.styler");c("div.jq-selectbox").filter(".opened").length&&e.onSelectClosed.call(c("div.jq-selectbox").filter(".opened"));if(!navigator.userAgent.match(/(iPad|iPhone|iPod)/g)){var b=h.data("li-height");if(e.selectSmartPositioning){var f=c(window),q=d.offset().top,n=f.height()-u-(q-f.scrollTop()),k=e.selectVisibleOptions,s=5*b,p=b*k;0<k&&6>k&&(s=p);0===k&&(p="auto");n>s+A+20?(g.height("auto").css({bottom:"auto",
top:C}),k=function(){m.css("max-height",Math.floor((n-20-A)/b)*b)},k(),m.css("max-height",p),"none"!=z&&m.css("max-height",z),n<g.outerHeight()+20&&k()):(g.height("auto").css({top:"auto",bottom:C}),k=function(){m.css("max-height",Math.floor((q-f.scrollTop()-20-A)/b)*b)},k(),m.css("max-height",p),"none"!=z&&m.css("max-height",z),q-f.scrollTop()-20<g.outerHeight()+20&&k())}c("div.jqselect").css({zIndex:e.singleSelectzIndex-1}).removeClass("opened");d.css({zIndex:e.singleSelectzIndex});g.is(":hidden")?
(c("div.jq-selectbox__dropdown:visible").hide(),g.show(),d.addClass("opened focused"),e.onSelectOpened.call(d)):(g.hide(),d.removeClass("opened"),c("div.jq-selectbox").filter(".opened").length&&e.onSelectClosed.call(d));h.filter(".selected").length&&(0!==m.innerHeight()/b%2&&(b/=2),m.scrollTop(m.scrollTop()+h.filter(".selected").position().top-m.innerHeight()/2+b));r.length&&(r.val("").keyup(),y.hide(),r.focus().keyup(function(){var a=c(this).val();h.each(function(){c(this).html().match(RegExp(".*?"+
a+".*?","i"))?c(this).show():c(this).hide()});1>h.filter(":visible").length?y.show():y.hide()}));l(m);return!1}});h.hover(function(){c(this).siblings().removeClass("selected")});var D=h.filter(".selected").text();h.filter(".selected").text();h.filter(":not(.disabled):not(.optgroup)").click(function(){var b=c(this),m=b.text();if(D!=m){var h=b.index(),h=h-b.prevAll(".optgroup").length;b.addClass("selected sel").siblings().removeClass("selected sel");f.prop("selected",!1).eq(h).prop("selected",!0);D=
m;q.html(m);d.data("jqfs-class")&&d.removeClass(d.data("jqfs-class"));d.data("jqfs-class",b.data("jqfs-class"));d.addClass(b.data("jqfs-class"));a.trigger("change.styler")}r.length&&(r.val("").keyup(),y.hide());g.hide();d.removeClass("opened");e.onSelectClosed.call(d)});g.mouseout(function(){c("li.sel",g).addClass("selected")});a.on("change.styler",function(){q.html(f.filter(":selected").text());h.removeClass("selected sel").not(".optgroup").eq(a[0].selectedIndex).addClass("selected sel");f.first().text()!=
h.filter(".selected").text()?d.addClass("changed"):d.removeClass("changed")}).on("focus.styler",function(){d.addClass("focused");c("div.jqselect").removeClass("opened")}).on("blur.styler",function(){d.removeClass("focused")}).on("keydown.styler keyup.styler",function(b){q.html(f.filter(":selected").text());h.removeClass("selected sel").not(".optgroup").eq(a[0].selectedIndex).addClass("selected sel");38!=b.which&&37!=b.which&&33!=b.which||g.scrollTop(g.scrollTop()+h.filter(".selected").position().top);
40!=b.which&&39!=b.which&&34!=b.which||g.scrollTop(g.scrollTop()+h.filter(".selected").position().top-g.innerHeight()+liHeight);32==b.which&&b.preventDefault();13==b.which&&(b.preventDefault(),g.hide())});c(document).on("click",function(a){c(a.target).parents().hasClass("jq-selectbox")||"OPTION"==a.target.nodeName||(c("div.jq-selectbox").filter(".opened").length&&e.onSelectClosed.call(c("div.jq-selectbox").filter(".opened")),r.length&&r.val("").keyup(),g.hide().find("li.sel").addClass("selected"),
d.removeClass("focused opened"))})}function t(){var e=new w,d=c("<div"+e.id+' class="jq-select-multiple jqselect'+e.classes+'"'+e.title+' style="display: inline-block; position: relative"></div>');a.css({margin:0,padding:0}).after(d);b();d.append("<ul>"+x+"</ul>");var k=c("ul",d).css({position:"relative","overflow-x":"hidden","-webkit-overflow-scrolling":"touch"}),n=c("li",d).attr("unselectable","on").css({"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","-o-user-select":"none",
"user-select":"none","white-space":"nowrap"}),e=a.attr("size"),p=k.outerHeight(),g=n.outerHeight();void 0!==e&&0<e?k.css({height:g*e}):k.css({height:4*g});p>d.height()&&(k.css("overflowY","scroll"),l(k),n.filter(".selected").length&&k.scrollTop(k.scrollTop()+n.filter(".selected").position().top));a.prependTo(d).css({position:"absolute",left:0,top:0,width:"100%",height:"100%",opacity:0});if(a.is(":disabled"))d.addClass("disabled"),f.each(function(){c(this).is(":selected")&&n.eq(c(this).index()).addClass("selected")});
else if(n.filter(":not(.disabled):not(.optgroup)").click(function(b){a.trigger("focus.styler");d.removeClass("focused");var h=c(this);b.ctrlKey||b.metaKey||h.addClass("selected");b.shiftKey||h.addClass("first");b.ctrlKey||(b.metaKey||b.shiftKey)||h.siblings().removeClass("selected first");if(b.ctrlKey||b.metaKey)h.is(".selected")?h.removeClass("selected first"):h.addClass("selected first"),h.siblings().removeClass("first");if(b.shiftKey){var e=!1,g=!1;h.siblings().removeClass("selected").siblings(".first").addClass("selected");
h.prevAll().each(function(){c(this).is(".first")&&(e=!0)});h.nextAll().each(function(){c(this).is(".first")&&(g=!0)});e&&h.prevAll().each(function(){if(c(this).is(".selected"))return!1;c(this).not(".disabled, .optgroup").addClass("selected")});g&&h.nextAll().each(function(){if(c(this).is(".selected"))return!1;c(this).not(".disabled, .optgroup").addClass("selected")});1==n.filter(".selected").length&&h.addClass("first")}f.prop("selected",!1);n.filter(".selected").each(function(){var a=c(this),b=a.index();
a.is(".option")&&(b-=a.prevAll(".optgroup").length);f.eq(b).prop("selected",!0)});a.trigger("change.styler")}),f.each(function(a){c(this).data("optionIndex",a)}),a.on("change.styler",function(){n.removeClass("selected");var a=[];f.filter(":selected").each(function(){a.push(c(this).data("optionIndex"))});n.not(".optgroup").filter(function(b){return-1<c.inArray(b,a)}).addClass("selected")}).on("focus.styler",function(){d.addClass("focused")}).on("blur.styler",function(){d.removeClass("focused")}),p>
d.height())a.on("keydown.styler",function(a){38!=a.which&&37!=a.which&&33!=a.which||k.scrollTop(k.scrollTop()+n.filter(".selected").position().top-g);40!=a.which&&39!=a.which&&34!=a.which||k.scrollTop(k.scrollTop()+n.filter(".selected:last").position().top-k.innerHeight()+2*g)})}var f=c("option",a),x="";a.is("[multiple]")?t():k()};k();a.on("refresh",function(){a.off(".styler").parent().before(a).remove();k()})}});else if(a.is(":reset"))a.on("click",function(){setTimeout(function(){a.closest(e.wrapper).find("input, select").trigger("refresh")},
