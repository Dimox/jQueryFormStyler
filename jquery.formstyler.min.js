...
e(this),l=b.text();if(A!=l){var g=b.index();b.is(".option")&&(g-=b.prevAll(".optgroup").length);b.addClass("selected sel").siblings().removeClass("selected sel");z?h.prop("selected",!1).eq(g-1).prop("selected",!0):h.prop("selected",!1).eq(g).prop("selected",!0);A=l;k.text(l);h.first().text()!=l?d.addClass("changed"):d.removeClass("changed");d.data("jqfs-class")&&d.removeClass(d.data("jqfs-class"));d.data("jqfs-class",b.data("jqfs-class"));d.addClass(b.data("jqfs-class"));a.change()}c.hide();d.removeClass("opened")});
c.mouseout(function(){e("li.sel",c).addClass("selected")});jQuery.expr[":"].contains=function(a,b,c,d){return 0<=(a.textContent||a.innerText||jQuery.text(a)||"").toLowerCase().indexOf(c[3].toLowerCase())};z.keyup(function(){g.show();e("#no_match").remove();c.height(y);var a=e(this).val();if(!1!=a){g.filter(":not(:contains('"+a+"')):not(."+w+")").hide();var a=g.filter(":contains('"+a+"')").size()+1,b=e("ul",d).innerHeight()+5;1==a&&(c.append('<li id="no_match" style="list-style-type: none">\u0421\u043e\u0432\u043f\u0430\u0434\u0435\u043d\u0438\u0439 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e</li>'),
