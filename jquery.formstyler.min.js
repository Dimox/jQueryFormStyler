...
e(this),l=b.text();if(A!=l){var g=b.index();b.is(".option")&&(g-=b.prevAll(".optgroup").length);b.addClass("selected sel").siblings().removeClass("selected sel");h.prop("selected",!1).eq(g-1).prop("selected",!0);A=l;k.text(l);h.first().text()!=l?d.addClass("changed"):d.removeClass("changed");d.data("jqfs-class")&&d.removeClass(d.data("jqfs-class"));d.data("jqfs-class",b.data("jqfs-class"));d.addClass(b.data("jqfs-class"));a.change()}c.hide();d.removeClass("opened")});c.mouseout(function(){e("li.sel",
